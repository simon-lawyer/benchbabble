...
rolling_path = os.path.join(static_folder, 'word_counts_by_year_rolling_5.pkl')
df_rolling = pd.read_pickle(rolling_path)

tf_idf_path = os.path.join(static_folder, 'tf_idf.pkl')
df_tf_idf = pd.read_pickle(tf_idf_path)
